...
export const footerData = {
  logo: LogoV2,
  address: ' Chaishai Food & Beverages Pvt Ltd Rohini Delhi-110085',
  email: 'info@chaishai.in',
  phone: '954-00-28204 (Main)',
  list1: [
    {
      name: 'Profile',
      href: '#',
...
export const copyrightData = {
  text: '© Chai Shai Food & Beverage Pvt Ltd, 2023. All rights reserved. Company Registration Number: 12345678.',
  icon: <BsChatDotsFill />,
};
